...
import EditCStiintificCIEFT from '../../../../../-components/KTabeleCommittees/EditCStiintificCIEFT.tsx';
import EditCRedactieCIEFT from '../../../../../-components/KTabeleCommittees/EditCRedactieCIEFT.tsx';
...
const ComiteteTest = () => {
  ...
  const scientificCommitteeMembers =
    committees?.filter(member => member.category === 'SCIENTIFIC_CIEFT') || [];

  const editorialCommitteeMembers =
    committees?.filter(member => member.category === 'EDITORIAL_CIEFT') || [];
